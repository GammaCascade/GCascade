...
def _library_path_config_message() -> str:
    return (
        ...
        "gcascade_v5.legacy.set_library_path('/path/to/LibrariesV5-legacy')."
    )
...
def _discover_default_library_path() -> Path:
    ...
    candidates = [
        Path.cwd() / "LibrariesV5-legacy",
        Path.cwd() / "GCascade" / "LibrariesV5-legacy",
        Path.home() / "GCascade" / "LibrariesV5-legacy",
    ...
    return (Path.cwd() / "LibrariesV5-legacy").resolve()
